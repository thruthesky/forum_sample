...
class AppStateNotifier extends ChangeNotifier {
  ForumSampleFirebaseUser? initialUser;
  ForumSampleFirebaseUser? user;
  ...
  void update(ForumSampleFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'postEdit',
              asyncParams: {
                'postDocument': getDoc('posts', PostsRecord.serializer),
              },
              builder: (context, params) => PostEditWidget(
                category: params.getParam('category', ParamType.String),
                postDocument:
                    params.getParam('postDocument', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'PostView',
              ...
              builder: (context, params) => PostViewWidget(
                postDocumentReference: params.getParam('postDocumentReference',
